# spraycoater_nodes_cpp/launch/servo.launch.py
import os
import yaml
...
def launch_setup(context, *args, **kwargs):
    ...
    #   c) package://spraycoater_nodes_cpp/config/paths.yaml
    candidates = []
    if paths_arg:
        candidates.append(paths_arg)
    candidates.append("package://mecademic_bringup/config/paths.yaml")
    candidates.append("package://spraycoater_nodes_cpp/config/paths.yaml")
