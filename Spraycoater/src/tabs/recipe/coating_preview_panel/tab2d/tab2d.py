...
# Lokale Imports aus dem tab2d Ordner
...
class Tab2D(QWidget):
    ...
    - View: Matplot2DView (Canvas)
    - Logic: ViewController2D (Steuerung)
    - UI: Views2DBox (Buttons)
    """
    ...
    def __init__(
        ...
        *,
        ...
        self.controller = ViewController2D(
            ...
            get_bounds=self._get_bounds_callable,
        )
        ...
        # Layout zusammenbauen: Oben Buttons, unten Plot
    ...
    def update_scene(
        ...
        try:
            ...
            # Delegiert das Setzen der Szene an die View
