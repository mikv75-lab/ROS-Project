...
def load_params(node) -> AppParams:
    ...
    # sichere declare/get Abfolge (überspringt bereits deklarierte)
    ...
    # Werte übernehmen (mit Typkonvertierung wo nötig)
